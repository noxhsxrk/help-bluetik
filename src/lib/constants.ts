...
/** อายุของโพสที่ได้รับการโปรโมต (18 ชั่วโมง) */
export const POST_PROMOTED_EXPIRY_MS = 18 * 60 * 60 * 1000; // 64,800,000 ms

/** ค่าคะแนนที่ต้องใช้ในการโปรโมตโพสต์ */
export const POINTS_TO_PROMOTE = 50;
